...
private:    
    ...
    GLuint  g_hYUVShaderProgram;
    GLuint       g_YUVVertexLoc     ;
    GLuint       g_YUVTexcoordLoc   ;
    GLuint positionHandle ;
    GLuint textureCoordHandle;
    GLuint textureHandleY ;
    GLuint textureHandleU ;
    GLuint textureHandleV ;
	GLuint texYId;
	GLuint texUId;
	GLuint texVId;
    GLuint textureForYUV;
